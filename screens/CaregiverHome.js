  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Text
          style={{ fontSize: 36, marginTop: 50, fontFamily: "Butler-Light" }}
        >
          Hi Ariel,
        </Text>
        <Text
          style={{ fontSize: 18, marginTop: 20, fontFamily: "Butler-Light" }}
        >
          Tracking Beatrice's location:
        </Text>
        ...
        <View style={{ marginTop: 10 }}>
          <Text style={{ fontSize: 24, fontFamily: "Butler-Light" }}>
            Beatrice's Tasks
          </Text>
